    ...
    return (
        <div className="flex-1 relative w-full">
            <div className="flex justify-center items-center text-center w-full bg-white rounded-md drop-shadow-2xl">
                ...
                <input onFocus={() => listRef.current.classList.remove("hidden")} onBlur={handleBlur} value={search} onChange={handleSearch} className="flex-1 py-2 border-none outline-none rounded-md rounded-l-none" placeholder="Search......" />
            </div>
