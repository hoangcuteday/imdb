...
function ItemSwipper({ id }) {
    ...
    return (
        <div className={cx('wrapper', 'w-full rounded-2xl relative')}>
            ...
            <span className={cx("text", "text-4xl font-semibold absolute top-[14%] text-[white] left-[5%]")}>{film.original_title}</span>
            <span className={cx("text", "absolute top-[36%] left-[5%] text-[#fcfcfd] text-sm max-w-sm line-clamp-3")}>{film.overview}</span>
